...
function openGmail() {
  const email = "PALIWALTANISHKA76@GMAIL.COM";
...
function downloadCV() {
  ...
  link.href = "Tanishka Paliwal Resume.pdf"; // Path to your resume file
  link.download = "Tanishka Paliwal Resume"; // Name for the downloaded file
